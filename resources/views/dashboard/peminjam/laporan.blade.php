    ...
    <div class="card mb-6">
        <header class="card-header">
            <p class="card-header-title">
                ...
                Jumlah Peminjam dalam Waktu Sebulan
            </p>
                ...
                <label class="checkbox">
                  ...
                  <div class="image">
                    <img src="https://avatars.dicebear.com/v2/initials/rebecca-bauch.svg" class="rounded-full">
                                ...
                                <td data-label="City">
                                    @if ($peminjam->isAktif)
                                        <button class="chip chip-green">Online</button>
                                </td>
                            @else
                        ...
                        <td data-label="Created">
                            <small class="text-gray-500"
                                title="Oct 25, 2021">{{ $peminjam->created_at->locale('id')->diffForHumans() }}</small>
                        </td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="dialog-content">
                                            ...
                                            <div class="dialog-footer">
                                                ...
                                                <form action="{{ route('peminjam.destroy', $peminjam->id) }}" class="ml-1"
                                                    method="post">
                                                    @method('delete')
                                                    @csrf
