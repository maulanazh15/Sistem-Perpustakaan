              ...
              <tr>
                ...
                <td class="actions-cell">
                  <div class="flex flex-row">
                    ...
                    <a href="/dashboard/pustakawan/{{ $buku->id }}/edit" class="button button-icon button-orange mr-2" data-ripple-light="true">
                      ...
                      <div class="modal-dialog">
                        <div class="dialog-content">
                          ...
                          <div class="dialog-footer">
                            ...
                            <form action="/dashboard/pustakawan/{{ $buku->id }}" class="ml-1" method="post">
                              @method('delete')
                              @csrf
