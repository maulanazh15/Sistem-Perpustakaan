        ...
        <div class="relative z-10 overflow-hidden bg-red-200 h-full w-full bg-cover pt-[120px] pb-[100px] md:pt-[130px] lg:pt-[160px]">
            <div class="container">
                <div class="-mx-4 flex flex-wrap items-center">
                    <div class="w-full px-4">
                        <div class="text-center">
                            <h1 class="text-4xl font-semibold text-blue-300">{{ $title }} Page</h1>
                        </div>
                    </div>
                </div>
            </div>
