        ...
        >
          <ul class="lg:flex">
            <li class="group relative">
              <a href="/welcome" class="ud-menu-scroll mx-8 flex py-2 text-base text-dark group-hover:text-primary lg:mr-0 lg:ml-7 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-12">
                  Laravel Docs
              </a>
            </li>
            <li class="group relative">
            ...
            <li class="group relative">
              <a
                href="/contact"
                class="ud-menu-scroll mx-8 flex py-2 text-base text-dark lg:mr-0 lg:ml-7 lg:inline-flex lg:py-6 lg:px-0 lg:text-white xl:ml-12 group-hover:text-primary lg:group-hover:text-white lg:group-hover:opacity-70"
              >
                Contact
              </a>
            </li>
            <li class="group relative">
              <a href="/dashboard" class="ud-menu-scroll mx-8 flex py-2 text-base text-dark group-hover:text-primary lg:mr-0 lg:ml-7 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-12">
                  Dashboard
              </a>
            </li>
